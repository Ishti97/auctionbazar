    ...
    <nav>
      ...
      <div class="logo"><a href="main.php?&username=<?php echo $username; ?>&identity=<?php echo $identity; ?>">Auction Bits
        ...
        <ul class="links">
          ...
          <li><a href="sold_product.php?&username=<?php echo $username; ?>&identity=<?php echo $identity; ?>" class="desktop-link">Sold Products</a>
            <input type="checkbox" id="show-features">
            <label for="show-features">Sold Products</label>
            <!-- <ul>
         ...
         <li><a href="cart.php?username=<?php echo $username; ?>&identity=<?php echo $identity; ?>">My Cart</a></li>
          ...
          <li><a href="Post/blogs.php?username=<?php echo $username; ?>&identity=<?php echo $identity; ?>">Content | Feedback</a></li>
