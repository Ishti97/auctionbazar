...
<script>
	function enable(e){
		if(e.checked){
			let curPrice = parseInt( document.querySelector("#totalPrice").innerText );
			curPrice += parseInt(e.parentElement.parentElement.childNodes[5].innerText);
			document.querySelector("#totalPrice").innerText = curPrice;
		}
		else {
			let curPrice = parseInt( document.querySelector("#totalPrice").innerText );
			curPrice -= parseInt(e.parentElement.parentElement.childNodes[5].innerText);
